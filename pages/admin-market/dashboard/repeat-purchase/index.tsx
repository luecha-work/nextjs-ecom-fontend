...
const RepeatPurchase: NextPage = () => {
  ...
  useEffect(() => {
    if (
      ...
      ordersService.getDashbordRepeatPurchase(filter).then((res) => {
        if (res?.status_code == 200) {
          setRowDataDisplay(res?.result);
        }
      });
        ...
        <Grid container spacing={2} columns={16}>
          ...
          <Grid item xs={14}>
            <Box
              ...
              alignContent="center"
            >
              <p className="titlePages">ภาพรวมสินค้าที่ซื้อซ้ำ</p>
            </Box>
